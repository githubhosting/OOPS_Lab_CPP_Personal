// write a menu driven programme to implement of class and object using stack datastructur in c++ push pop and display
#include <iostream>
#define SIZE 5
using namespace std;
...
void STACK::displayItems() // to display the items
{
    int i;
    cout << "STACK is: ";
    for (i = (top); i >= 0; i--)
